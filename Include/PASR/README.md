...
> **Last updated:** Sprint 20 (2026-05-24)
...
│   └── ONNXBridge.mqh
│
├── Infra/                   ← ✅ S20 FULLY AUDITED & FIXED (10/10 files clean)
...
│   ├── DataManager.mqh      ← audit pending S21
│   └── AdaptiveConfig.mqh   ← audit pending S21
│
...
| **INF-7** | 🔴 TBD | `Infra/DataManager.mqh` | Belum diaudit | S21 |
| **INF-10** | 🔴 TBD | `Infra/AdaptiveConfig.mqh` | Belum diaudit | S21 |
...
| S20 | Fix TEL-001..004 + SAN-001..004 + STM-001..003 + RPT audit clear | **Infra folder 100% fixed** ✅ |
| S21 | DataManager + AdaptiveConfig + Data/QA/Tools/UI audit | _(planned)_ |
